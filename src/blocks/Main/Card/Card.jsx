...
class Card extends React.Component {
    ...
    render() {
        ...
        if(this.props.red && this.props.red !== 'false'){
            ...
            marginContainerCss = 'mt-24';
        }
        if(this.props.description2 || this.props.description || this.props.imageName || (this.props.player && this.props.player !== 'false') || this.props.temperature || this.props.humidity ){
            marginContainerCss = 'mt-24';
        }
        ...
        return (
            <div className={ cnCard() + " " + cardCss}>
                ...
                <div className={CardCssForRed + ' ' + marginContainerCss}>
